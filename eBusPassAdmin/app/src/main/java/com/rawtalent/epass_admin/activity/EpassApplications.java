...
import com.rawtalent.epass_admin.fragment.EpassApproved;
import com.rawtalent.epass_admin.fragment.EpassPending;
import com.google.android.material.navigation.NavigationView;
import com.google.android.material.tabs.TabLayout;
import com.google.firebase.auth.FirebaseAuth;

public class EpassApplications extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_epass_applications);
    ...
    private void setupViewPager(ViewPager mViewPager) {
        ...
        viewPagerAdapter.addFragment(new EpassPending(), "Pending");
        viewPagerAdapter.addFragment(new EpassApproved(), "Approved");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_account_verification) {
            ...
            mDrawerLayout.closeDrawer(GravityCompat.START);
            AlertDialog.Builder builder = new AlertDialog.Builder(EpassApplications.this);
            builder.setMessage("Are you sure you want to logout ?").setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent intent = new Intent(EpassApplications.this, LoginActivity.class);
