...
public class ApplicationPending extends Fragment {
    ...
    public ApplicationPending() {
        // Required empty public constructor
    }

    public ApplicationPending(Context mContext) {
        // Required empty public constructor
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_application_pending, container, false);
        mrecylerview=view.findViewById(R.id.recyclerview);
        animationView=view.findViewById(R.id.animation_view);
        firebaseFirestore = FirebaseFirestore.getInstance();
        Query query = firebaseFirestore.collection("student").whereEqualTo("isVerified","0");
