...
public class EpassApproved extends Fragment {
    ...
    private static FirestoreRecyclerAdapter firestoreRecyclerAdapter;
    private FirebaseAuth mAuth;
    LottieAnimationView animationView;


    public EpassApproved() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_epass_approved, container, false);
        mrecylerview=view.findViewById(R.id.recyclerview);
        animationView=view.findViewById(R.id.animation_view);

        firebaseFirestore = FirebaseFirestore.getInstance();
        Query query = firebaseFirestore.collection("ePasses").whereEqualTo("verificationStatus","1");
            ...
            protected void onBindViewHolder(@NonNull final StudentViewHolder holder, final int position, @NonNull final EpassModel model) {
                ...
                holder.verifyDetails.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("epass", (Serializable) model);
